...
var networkIdHostsIdActionsContainersId = require('./routes/network-id-hosts-id-containers-id.js');
 ...
 */
app.get('/networks/:networkIp/hosts/:hostIp/containers/:containerId',
  networkIdHostsIdActionsContainersId.getMapping);
