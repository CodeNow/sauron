...
class Publisher extends RabbitMQ {
   ...
   */
  static publishContainerNetworkAttached (data) {
   ...
   * @param {Object} data data to pass to job
   */
  static publishWeavePeerForget (data) {
   ...
   * @param {Object} data data to pass to job
   */
  static publishWeavePeerRemove (data) {
